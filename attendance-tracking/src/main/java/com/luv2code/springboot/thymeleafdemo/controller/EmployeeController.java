...
import com.luv2code.springboot.thymeleafdemo.entity.AddressesWrapper;
import com.luv2code.springboot.thymeleafdemo.entity.Department;
import com.luv2code.springboot.thymeleafdemo.entity.Employee;
import com.luv2code.springboot.thymeleafdemo.entity.EmployeeTL;
import com.luv2code.springboot.thymeleafdemo.entity.Note;
import com.luv2code.springboot.thymeleafdemo.entity.NoteTL;
import com.luv2code.springboot.thymeleafdemo.entity.NotesWrapper;
import com.luv2code.springboot.thymeleafdemo.entity.NotesWrapperTL;
import com.luv2code.springboot.thymeleafdemo.entity.Phone;
import com.luv2code.springboot.thymeleafdemo.entity.PhonesWrapper;
import com.luv2code.springboot.thymeleafdemo.service.AddressLabelService;
...
import com.luv2code.springboot.thymeleafdemo.service.GenericService;
import com.luv2code.springboot.thymeleafdemo.service.PhoneService;
...
public class EmployeeController {
	...
	public String addAddress(@RequestParam("employeeId") String theId, Model theModel) {
		...
		List<Address> addresses = addressService.findAll(employee.getEmplId());

		// add one empty address
		Address address = new Address();
		address.setEmplId(employee.getEmplId());
	...
	public String addPhone(@RequestParam("employeeId") String theId, Model theModel) {
		...
		phone.setEmplId(employee.getEmplId());
		phones.add(phone);
	...
	public String saveEmployee(
			...
			@Valid EmployeeTL theEmployee, BindingResult bindingResult, RedirectAttributes redirectAttributes,
			Model theModel) {

		if (bindingResult.hasErrors()) {
			UserMessage userMessage = new UserMessage("Failed to save!");
