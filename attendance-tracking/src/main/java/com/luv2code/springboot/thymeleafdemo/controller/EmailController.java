...
import com.luv2code.springboot.thymeleafdemo.entity.Email;
import com.luv2code.springboot.thymeleafdemo.entity.EmailsWrapper;
...
public class EmailController {
	...
	public String addEmail(
		...
		email.setEmplId(employee.getEmplId());
		emails.add(email);
